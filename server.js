...
app.post("/search", (req, res) => {
    ...
    let movieUrl =`https://api.themoviedb.org/3/search/movie?api_key=95fce9d1198043b454f93509d77107b4&query=${userMovieTitle}`;
    let genresUrl = "https://api.themoviedb.org/3/genre/movie/list?api_key=95fce9d1198043b454f93509d77107b4&language=en-US";
